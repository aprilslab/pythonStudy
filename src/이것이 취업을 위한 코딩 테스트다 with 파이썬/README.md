...
* 이론
    * 당장 좋은 것만 선택하는 그리디
    * 거스름돈 문제: ([Python 3.9 코드](03장%20그리디.ipynb))
* 실전
    * 동빈이의 큰 수의 법칙: ([Python 3.9 코드](03장%20그리디.ipynb))
    * 숫자 카드게임: ([Python 3.9 코드](03장%20그리디.ipynb))
    * 1이 될 때까지: ([Python 3.9 코드](03장%20그리디.ipynb))

#### 4장 구현

* 이론
    * 아이디어를 코드로 바꾸는 구현
    * 상하좌우: ([Python 3.9 코드](04장%20구현.ipynb))
    * 시각: ([Python 3.9 코드](04장%20구현.ipynb))
* 실전
    * 왕실의 나이트: ([Python 3.9 코드](04장%20구현.ipynb))
    * 게임 개발: ([Python 3.9 코드](04장%20구현.ipynb))
